  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] font-display text-gray-800 antialiased selection:bg-emerald-600 selection:text-white pb-12">
      <header className="sticky top-0 z-50 flex items-center justify-between px-6 py-5 backdrop-blur-xl bg-[#FAFAFA]/80">
        ...
        <span className="text-sm font-semibold tracking-wide text-gray-500 uppercase">Consultation</span>
      ...
      <main className="flex-1 flex flex-col px-6 gap-10">
        <section className="mt-2 text-center animate-fade-in">
          <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 mb-3">
            Premium QA <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-500">Expertise</span>
          </h1>
          <p className="text-gray-500 text-sm font-body leading-relaxed max-w-[280px] mx-auto">
            Elevate your product reliability with tailored testing strategies and enterprise-grade quality assurance.
          </p>
        </section>
            ...
            <div className="group relative rounded-2xl bg-white p-6 shadow-sm border border-gray-100 hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-300">
              <div className="flex justify-between items-start">
                <div className="space-y-1">
                  <span className="inline-block py-1 px-2.5 rounded-md bg-gray-50 text-[10px] font-bold uppercase tracking-wider text-gray-500">Starter</span>
                  <h3 className="font-bold text-xl text-gray-900">Essential Audit</h3>
                </div>
              ...
              <div className="my-6 space-y-3">
                {['Exploratory Testing', 'Detailed Bug Report', '1 Platform (iOS or Android)'].map((item, i) => (
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-6">
                  <div className="space-y-1">
                    ...
                    <h3 className="font-bold text-2xl tracking-tight">Pro Hybrid</h3>
                  </div>
                  <div className="text-right">
                    <span className="block text-2xl font-bold">$850</span>
                    <span className="text-[10px] text-gray-400 font-medium uppercase tracking-wide">/ Project</span>
                  </div>
                </div>
                <div className="space-y-4 mb-8">
                  <p className="text-sm text-gray-300 font-body leading-relaxed border-l-2 border-emerald-500 pl-3">
                    Comprehensive coverage combining manual depth with automated efficiency.
                  </p>
                  <ul className="space-y-3 pt-2">
                    {['Manual + Auto Smoke Tests', '5 Devices Coverage', 'Test Plan & Custom Scripts'].map((item, i) => (
        ...
        <section className="relative animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <div className="mb-8 text-center">
            <h2 className="text-2xl font-bold tracking-tight text-gray-900 mb-3">Consultation</h2>
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs mx-auto">
              Secure your spot for a technical deep dive.
            </p>
          </div>
          <form className="flex flex-col gap-6 bg-white p-6 rounded-2xl shadow-lg shadow-gray-100 border border-gray-100">
            <div className="grid grid-cols-1 gap-5">
              <div className="group">
                <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-1.5 transition-colors group-focus-within:text-emerald-600">Full Name</label>
                <input className="w-full bg-gray-50 border-0 rounded-lg px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:ring-1 focus:ring-emerald-600 transition-all shadow-inner" placeholder="John Doe" type="text" />
              </div>
              <div className="group">
                <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-1.5 transition-colors group-focus-within:text-emerald-600">Work Email</label>
                <input className="w-full bg-gray-50 border-0 rounded-lg px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:ring-1 focus:ring-emerald-600 transition-all shadow-inner" placeholder="john@company.com" type="email" />
              </div>
            </div>
            <div className="group">
              <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-2">Interest</label>
              <div className="flex flex-wrap gap-2">
                {['Web App', 'Mobile', 'API', 'Consulting'].map((interest, i) => (
